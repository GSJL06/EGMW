...
export const studentsApi = {
  ...
  getByInstitution: (
    ...
    apiService.get<PaginatedResponse<any>>(
      `/students/institution/${institutionId}`,
      { params }
    ),

  getByStatus: (status: string, params?: { page?: number; size?: number }) =>
    apiService.get<PaginatedResponse<any>>(`/students/status/${status}`, {
      params,
    }),

  existsByCode: (code: string) =>
    apiService.get<boolean>(`/students/exists/code/${code}`),

  countByInstitution: (institutionId: number) =>
    apiService.get<number>(`/students/count/institution/${institutionId}`),

  countByStatus: (status: string) =>
    apiService.get<number>(`/students/count/status/${status}`),
};
...
export const teachersApi = {
  ...
  getByInstitution: (
    ...
    apiService.get<PaginatedResponse<any>>(
      `/teachers/institution/${institutionId}`,
      { params }
    ),

  getByStatus: (status: string, params?: { page?: number; size?: number }) =>
    apiService.get<PaginatedResponse<any>>(`/teachers/status/${status}`, {
      params,
    }),

  existsByCode: (code: string) =>
    apiService.get<boolean>(`/teachers/exists/code/${code}`),

  countByInstitution: (institutionId: number) =>
    apiService.get<number>(`/teachers/count/institution/${institutionId}`),

  countByStatus: (status: string) =>
    apiService.get<number>(`/teachers/count/status/${status}`),
};
...
export const coursesApi = {
  ...
  getByTeacher: (
    ...
    apiService.get<PaginatedResponse<any>>(`/courses/teacher/${teacherId}`, {
      params,
    }),

  getByStatus: (status: string, params?: { page?: number; size?: number }) =>
    apiService.get<PaginatedResponse<any>>(`/courses/status/${status}`, {
      params,
    }),
  ...
  existsByCode: (code: string) =>
    apiService.get<boolean>(`/courses/exists/code/${code}`),
};
